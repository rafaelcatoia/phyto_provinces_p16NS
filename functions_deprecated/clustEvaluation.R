...
#distMatrixEval = list_dist$geo_Dist_mirrored
#vetClusterMembership = mat_hclust[,1]

clustEvaluation <- function(distMatrixEval,vetClusterMembership){

  dfX = data.frame(X=vetClusterMembership)
